...
class MessageHandler:
    ...
    def download_photo(self, media_url: str, job_id: str) -> Optional[str]:
        """
        Download photo from Twilio media URL

        Args:
            media_url: Direct URL to media content from Twilio
        ...
        try:
            ...
            logger.error(f"Error downloading photo from {media_url}: {e}")
            return None
